...
namespace Sabio.Web.Controllers.Api.Tests
{
    ...
    public class TestCenterApiController : ApiController
    {
        ...
        [Route("appUserId"), HttpGet]
        public HttpResponseMessage TestGetAppUserId(object model)
        {
            ...
            int appUserId = UserService.GetAppUserId(other_looks_like_a_guid);


            //SomeService.Do(appUserId, model);
